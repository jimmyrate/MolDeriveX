...
from .utils.mol_utils.selfies_vae.model_positional_unbounded import SELFIESDataset, InfoTransformerVAE
from .utils.mol_utils.selfies_vae.data import collate_fn
...
class MoleculeObjective(LatentSpaceObjective):
    ...
    def __init__(
        self,
        task_id='pdop',
        path_to_vae_statedict="/root/PSL-MOBO/lolbo/utils/mol_utils/selfies_vae/state_dict/SELFIES-VAE-state-dict.pt",
        xs_to_scores_dict={},
    ...
    def vae_decode(self, z):
        ...
        return decoded_mols,decoded_smiles
